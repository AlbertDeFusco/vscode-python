...
(mockedVSCode as any).DebugProtocolVariable = vscodeMocks.vscMock.DebugProtocolVariable;
(mockedVSCode as any).DebugProtocolVariableContainer = vscodeMocks.vscMock.DebugProtocolVariableContainer;
